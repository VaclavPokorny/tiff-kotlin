...
public class ByteWriter {
    ...
    public void writeShort(short value) throws IOException {
        ...
        ByteBuffer byteBuffer = ByteBuffer.allocate(2).order(byteOrder).putShort(value);
        byteBuffer.flip();
    ...
    public void writeUnsignedShort(int value) throws IOException {
        byte[] valueBytes = new byte[2];
        ByteBuffer byteBuffer = ByteBuffer.allocate(2).order(byteOrder).putShort((short) (value & 0xffff));
        byteBuffer.flip();
        byteBuffer.get(valueBytes);
        os.write(valueBytes);
    }
    ...
    public void writeUnsignedInt(long value) throws IOException {
        byte[] valueBytes = new byte[4];
        ByteBuffer byteBuffer = ByteBuffer.allocate(4).order(byteOrder).putInt((int) (value & 0xffffffffL));
        byteBuffer.flip();
        byteBuffer.get(valueBytes);
        os.write(valueBytes);
    }
    ...
    public void writeFloat(float value) throws IOException {
        byte[] valueBytes = new byte[4];
        ByteBuffer byteBuffer = ByteBuffer.allocate(4).order(byteOrder).putFloat(value);
        byteBuffer.flip();
        byteBuffer.get(valueBytes);
        os.write(valueBytes);
    }
