...
object TiffTestUtils {
    ...
    fun compareRastersSampleValues(
        ...
        Assertions.assertEquals(
            rasters1.sampleValues.size, rasters2.sampleValues.size
        )
    ...
    fun compareRastersInterleaveValues(
        ...
        Assertions.assertEquals(
            rasters1.interleaveValues.capacity() / rasters1.sizePixel(), rasters2.interleaveValues.capacity() / rasters2.sizePixel()
        )
